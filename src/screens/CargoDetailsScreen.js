...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 14, fontWeight: '800', color: colors.secondary, textTransform: 'uppercase' },
  partyBox: { paddingVertical: 5 },
  partyRole: { fontSize: 10, fontWeight: 'bold', color: colors.primary, textTransform: 'uppercase', marginBottom: 4 },
  partyName: { fontSize: 16, fontWeight: 'bold', color: '#1e293b' },
  partySubText: { fontSize: 12, color: '#94a3b8', marginBottom: 8 },
  detailRow: { flexDirection: 'row', alignItems: 'center', marginTop: 4 },
  detailText: { fontSize: 13, color: '#475569', marginLeft: 8, flex: 1 },
  ...
  infoVal: { fontSize: 14, fontWeight: '600', color: '#1e293b', marginTop: 2 },
  ...
  amountValue: { fontSize: 15, color: '#1e293b', fontWeight: '700' },
  netTotalContainer: { marginTop: 10, paddingTop: 15, borderTopWidth: 2, borderTopColor: '#f1f5f9' },
  netTotalLabel: { fontSize: 16, color: '#1e293b', fontWeight: '800' },
  netTotalValue: { fontSize: 18, color: colors.primary, fontWeight: '900' }
});